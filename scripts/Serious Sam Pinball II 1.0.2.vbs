...
Const cGameName = "serioussam2"
Const TableName = "SeriousSam2"
...
Sub StartBattle
    ...
    Select Case NewBattle
        Case 1 'Bast = Super Spinners
            DMD CL(0, "BAST"), CL(1, "SHOOT THE SPINNERS"), "", eNone, eNone, eNone, 1500, True, ""
            Light33.State = 2
            Light35.State = 2
            SpinCount = 0
        Case 2 'Isis = Super Pop Bumpers
            DMD CL(0, "ISIS"), CL(1, "HIT THE POP BUMPERS"), "", eNone, eNone, eNone, 1500, True, ""
            Light55.State = 2
            LightSeqBumpers.Play SeqRandom, 10, , 1000
            SuperBumperHits = 0
        Case 3 'Amon = Ramps
            DMD CL(0, "AMON"), CL(1, "SHOOT THE RAMPS"), "", eNone, eNone, eNone, 1500, True, ""
            Light36.State = 2
            Light34.State = 2
            RampHits = 0
        Case 4 'Shu = Orbits
            DMD CL(0, "SHU"), CL(1, "SHOOT THE ORBITS"), "", eNone, eNone, eNone, 1500, True, ""
            OrbitHits = 0
            Light33.State = 2
            Light35.State = 2
        Case 5 'Set = Shoot the lights 2
            DMD CL(0, "SET"), CL(1, "SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            Light29.State = 2
            Light30.State = 2
            Light31.State = 2
            Light32.State = 2
        ...
        Case 6 'Nepthys= Shoot the lights 1
            DMD CL(0, "NEPTHYS"), CL(1, "SHOOT THE LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            Light30.State = 2
        Case 7 'Bes =  Blue Target Frenzy
            DMD CL(0, "BES"), CL(1, "SHOOT THE TARGETS"), "", eNone, eNone, eNone, 1500, True, ""
            TargetHits = 0
            LightSeqBlueTargets.Play SeqRandom, 10, , 1000
        Case 8 'Serget = Left & Right Targets
            DMD CL(0, "SERGET"), CL(1, "SHOOT THE TARGETS"), "", eNone, eNone, eNone, 1500, True, ""
            TargetHits = 0
            Light31.State = 2
            Light29.State = 2
        Case 9 'Anubis = Follow the Lights 1
            DMD CL(0, "ANUBIS"), CL(1, "SHOOT LIT LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            LightHits = 0
            FollowTheLights.Enabled = 1
        Case 10 'Osiris = Super Loops
            DMD CL(0, "OSIRIS"), CL(1, "SHOOT THE LOOPS"), "", eNone, eNone, eNone, 1500, True, ""
            loopCount = 0
            Light33.State = 2
            Light35.State = 2
            Gate2.Open = 1
        ...
        Case 11 'Horus = Follow the Lights 2
            DMD CL(0, "HORUS"), CL(1, "SHOOT LIT LIGHTS"), "", eNone, eNone, eNone, 1500, True, ""
            LightHits = 0
            FollowTheLights.Enabled = 1
        Case 12 'Ra = Ramps and Orbits
            'uses the ramphits to count the hits
            DMD CL(0, "RA"), CL(1, "SHOOT RAMPS ORBITS"), "", eNone, eNone, eNone, 1500, True, ""
            RampHits = 0
            Light36.State = 2
            Light34.State = 2
        Case 13 'Mordekai the Summoner - the final battle
            DMD CL(0, "MORDEKAI BATTLE"), CL(1, "SHOOT THE JACKPOTS"), "", eNone, eNone, eNone, 1500, True, ""
            AddMultiball 4
            StartJackpots
            ChangeGi 5
    End Select
