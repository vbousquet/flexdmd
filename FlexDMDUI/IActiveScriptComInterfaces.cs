namespace FlexDMDUI
{
	...
	/* 
	 * A good series of articles for working with Scripting Host unter .NET
	...
	internal class ActiveScriptParseWrapper
	{
		...
		internal void ReleaseComObject()
		{
			if (asp32 != null)
			{
				Marshal.ReleaseComObject(asp32);
			}
			else
			{
				Marshal.ReleaseComObject(asp64);
			}
		}
	...
	[ComImport]
	[Guid("b54f3741-5b07-11cf-a4b0-00aa004a55e8")]
