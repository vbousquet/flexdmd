...
namespace UltraDMD
{
    ...
    {
        private readonly IUltraDMD _udmd = null;
        ...
        public void LoadSetup() => _udmd.LoadSetup();
        ...
        public void DisplayScoreboard00(int cPlayers, int highlightedPlayer, Int64 score1, Int64 score2, Int64 score3, Int64 score4, string lowerLeft, string lowerRight) => _udmd.DisplayScoreboard00(cPlayers, highlightedPlayer, score1, score2, score3, score4, lowerLeft, lowerRight);
