...
Sub DMDUpdate(id)
    ...
    Select Case id
        ...
        Case 2 ' back image - back animations
			...
			If Not FlexDMD is Nothing Then DMDScene.GetImage("Back").Bitmap = FlexDMD.NewImage("", "VPX." & dLine(2) & "&dmd=3").Bitmap
    End Select
...
Sub DMDDisplayChar(achar, adigit)
	...
	If Not FlexDMD is Nothing Then DMDScene.GetImage("Dig" & adigit).Bitmap = FlexDMD.NewImage("", "VPX." & Chars(achar) & "&dmd=3&add").Bitmap
End Sub
